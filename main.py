...
# ========== ДОБАВИТЬ ЭТОТ БЛОК ==========
# Фикс для работы на Render.com
if os.environ.get('FPC_IS_RUNNING_ON_RENDER'):
    # Отключаем проверку на systemd сервис
    os.environ['FPC_IS_RUNNIG_AS_SERVICE'] = '0'
# ========================================
...
# ... дальше идет ваш logo и остальной код без изменений
